    ...
    public static class ModelBuilderDataGenerator
    {
        public static void GenerateData(this ModelBuilder builder)
        {
            ...
            builder.Entity<Weapon>().HasData(
                ...
                new Weapon() { WeaponId = 3, Name = "Heheheh", Description = "You lie", Force = 32, Image = "https://publicdomainvectors.org/photos/Shield-ClassicMedieval1.png", Price = 320, Qty = 2, QtyBought = 1, CreatedDate = new DateTime(2000, 01, 1) }
